...
def inserir_deals(a):
    ...
    ocorrencias = {"54": "2ª Via de Nota fiscal","56": "2ª Via de Boleto","58": "Assistência de Marca Exclusiva",
                   "1522": "Atendimento Loja - Elogio","52": "Atendimento loja - Sugestão","218": "Atendimento loja - Reclamação",
                   "528": "Atendimento do motorista / Entregador - elogio","530": "Atendimento do motorista / Entregador - reclamação",
                   "554": "Atraso na entrega","560": "Atendimento Loja","816": "Atendimento SAC - Elogio",
                   "818": "Atendimento SAC - Reclamação","1464": "Canhoto de Entrega","74": "Cliente discorda da Norma de Entrega",
                   ...
                   "534": "Refazer pedido","532": "Raio de entrega / Frete","804": "Resgate do termo de entrega assinado",
    ...
    ocorrencias_sacs = {
         ...
         "304": "Falta de produto na loja","306": "Ordem coleta / Desacordo (Erro logistica)","308": "Ordem coleta / Desacordo (Erro loja)",
    ...
    ocorrencias_e = {
            ...
            "462": "Cliente recebeu mercadoria duplicada (Pessoa jurídica)","808": "Cliente só recebe outro dia - Retirar de carga",
    ...
    ocorrencias_ms = {"575": "2ª via nota fiscal ","577": "Atendimento Vendedores - Reclamação","579": "Atendimento Frete de loja",
                    ...
                    "593":"Campanha promocional - Solicitação","820": "Consulta de Entrega","1118": "Elogio Motorista",
                    "595": "Especificação de produto","1114":"Feedback","597":"Fornecedor, parceria e patrocínio ",
                    "599": "horário de atendimento", "607": "Insatisfação com a compra","810": "Interação do cliente",
    ...
    ocorrencias_d = {"1578": "2ª via de boleto","1580": "2ª via de NF (SaÍda)","1582": "2ª via nota (entrada)\"",
                     ...
                     "1588": "Previsão de entrega","1590": "Atraso na entrega","1592": "Ressarcimento De credito de Devolução",
                     "1594": "Solicitação de arquivo XML","1596": "Sol. Visita RCA","1598": "Cadastro de cliente Distac",
                     "1600": "Consultar pedido","1602": "Cadastro / navegação do E-Commerce","1604": "Problemas na plataforma do E-Commerce",
                     ...
                     "1650": "Atendimento SAC - Reclamação","1612": "Atendimento RCA - Elogio","1654": "Atendimento RCA - Reclamação"}
    while True:
    ...
    return("INSERT INTO DEAL (ID, Pipeline, Negócio_repetido, Fase,"
           ...
           .format(a['ID'],pipeline,a['IS_RETURN_CUSTOMER'],fase,
                   a['ASSIGNED_BY_ID'], a['TITLE'], tipo, fonte, a['COMPANY_ID'], a['CONTACT_ID'], a['CLOSED'],
...
def inserir_contato(a):
    ...
    return ("INSERT INTO CONTACT (ID, Nome,Sobrenome,Tipo_de_Contato,Responsável,Telefone_de_trabalho,"
            ...
            " '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}',"
            " '{}', '{}')"
            .format(a['ID'], a['NAME'], sobrenome, tipo_contato, a['ASSIGNED_BY_ID'], telefone,
                   a['HAS_EMAIL'], fonte, a['EXPORT'], a['CREATED_BY_ID'], a['DATE_CREATE'], a['MODIFY_BY_ID'],
...
def atualizar_contato(a):
    ...
    return("UPDATE CONTACT SET Nome='{}',Sobrenome='{}',Tipo_de_Contato='{}',Responsável='{}',Telefone_de_trabalho='{}',"
           ...
           "Estado_UF='{}'"
           " WHERE ID='{}'"
           .format(a['NAME'], sobrenome, tipo_contato, a['ASSIGNED_BY_ID'], telefone,
                   a['HAS_EMAIL'], fonte, a['EXPORT'], a['CREATED_BY_ID'], a['DATE_CREATE'], a['MODIFY_BY_ID'],
                   a['DATE_MODIFY'],a['UF_CRM_1571660034'], a['UF_CRM_1571691442204'], a['UF_CRM_1572279163418'],
                   a['UF_CRM_1572280054175'], a['UF_CRM_1572280080310'], a['UF_CRM_1572280097701'], a['UF_CRM_1572284963545'],
                   a['UF_CRM_1572284981193'], a['UF_CRM_1572285018856'], a['UF_CRM_1572285028298'], a['UF_CRM_1572285037562'],
